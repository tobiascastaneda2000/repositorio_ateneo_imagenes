function sketch(p){
  ...
  p.setup=() =>{
    ...
    Font2=p.createFont("RobotoCondensedRegular.otf",50);
    p.textFont(Font);
    m=p.millis();
    ...
    burbujas[i] = new Burbuja (p.random(p.width),p.random(p.height)+20*i,p.color(48,66,253));}
    for( i =0; i<flowers.length; i++)
      { 
        flowers[i]= new Flower(color1,color4);}
